...
\end{eqnarray}
Lassen sich die begrenzenden Widerstände für die interne Sicherheitsschaltung berechnen. Als Grundlage wurden die Widerstandswerte vom Datenblatt übernommen: $RTH_{COLD} = 27,28\text{k}\Omega$ und $RTH_{HOT} = 4,912\text{k}\Omega$.
\begin{eqnarray}
...
\item
Mikrocontroller CC2541 mit integrierter Transmitter-Einheit
\item
...
\item
Datenleitungen für SPI\footnote{serial peripheral interface}
\item
