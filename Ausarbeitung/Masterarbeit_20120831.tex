...
\begin{table}[h]
	...
	\begin{tabular}{|l l|}\hline
		Aufgabensteller: & Prof. Dipl.-Phys. Anton Harasim\\ \hline
		Betreuer: & Dipl.-Ing. Sophie Engelsberger\\ \hline
		Matrikelnummer: & 740131 \\ \hline
		Arbeit vorgelegt am: & \today\\ \hline
	\end{tabular}
\end{table}
...
\vspace*{2 cm}
\\
Landshut, den \today \qquad \qquad \qquad  \qquad \qquad (Stephan Jobstmann)
\chapter*{Zusammenfassung}
Die vorliegende Arbeit ist Teil des Projekts MedLast an der Hochschule Landshut, Fakultät Elektrotechnik und Wirtschaftsingenieurwesen. Ziel des Projekts ist ein System zu entwickeln, dass eine Überwachung des Genesungsprozesses sowohl für den Patienten als auch für den behandelnden Arzt ermöglicht. Dabei wird in der Fußschiene ein Elektronikmodul eingesetzt, dass Schrittzahl und Belastung auswertet. Diese Daten werden einerseits in einem Speicher für den Orthopäden aufgezeichnet und andererseits in Echtzeit für den Patienten verständlich aufbereitet und an eine Anzeige am Handgelenk desjenigen weitergeleitet. So hat der Genesende stets einen Überblick über Belastung seines Beines.\\
Ziel dieser Arbeit ist es, ein funktionierendes Konzept für die Elektronik des Fußmoduls zu entwickeln. Dies schließt
\begin{itemize}
\item
eine Auswertung der Belastung über eine Sensorikschaltung,
\item
eine verschleißfreie Aktivierung über einen Piezodruckaufnehmer,
\item
einen akustischen Signalgeber bei Überbelastung, 
\item
diverse Schaltungen zur Sicherheit und Leistungsoptimierung,
\item
ein Empfängermodul für drahtlose Energieübertragung und 
\item
eine Einheit zur Energiebereitstellung 
\end{itemize}
mit in die Aufgabenstellung mit ein. 
\newline\newline
Es wurden bei der Bearbeitung der Thematik folgende Ergebnisse erzielt:
\begin{itemize}
\item
Während der Voruntersuchung wurde empirisch bewiesen, dass bei hinreichenden Störfaktoren während der Messung und bei kleiner Auslenkung unter 200 Newton eine kapazitive Messmethode mit Piezoelementen unzureichende Ergebnisse liefern. 
\item
Energy-Harvesting wurde im Bereich der thermoelektrischen Wandlung getestet. Allerdings hat sich beim praktischen Aufbau und bei der kommerziellen Betrachtung die drahtlose Energieübertragung als Energiezuführung für das System sich durchgesetzt. Ein eigener Aufbau eines Empfängers in Dickschichttechnik wurde bereits erfolgreich in Betrieb genommen. 
\item
...
\item
Die Sensorik wurde samt Auswertungsbaustein erfolgreich an mehreren eingebetteten Systemen getestet. Darunter war auch das oben genannte modifizierte Evaluations-Modul.
\end{itemize}
%\maketitle
%\setcounter {page}{1}
...
\caption[Longitudinaler Piezoeffekt; Kristallstruktur und Ladungsverschiebung]{Longitudinaler Piezoeffekt; Aufbau der Kristallstruktur und Ladungsverschiebung}
      \begin{center}
       \fbox{\includegraphics[width=1\textwidth-2\fboxsep-2\fboxrule]{Bilder/Piezo.png}}
      \end{center}
...
\caption{Ladungskurve eines typischen Lithium-Ionen-Akkumulators}
      \begin{center}
       \fbox{\includegraphics[width=1\textwidth-2\fboxsep-2\fboxrule]{Bilder/ion1.jpg}}
      \end{center}
...
\begin {figure}[htbp]
	\caption[Messung 1; Sonox 502 Kapazitives Verhalten]{Messung 1; Sonox 502 Kapazitives Verhalten über steigende mechanische Belastung}
      \begin{center}
\fbox{\includegraphics[width=0.8\textwidth-2\fboxsep-2\fboxrule]{tabelle2_1_1}}
      \end{center}
Quelle: Stephan Jobstmann
\label{fig:2.1}
\end{figure}
...
\caption[Messung 2; Sonox 502 Statisches Verhalten]{Messung 2; Sonox 502 Statisches Verhalten über steigende mechanische Belastung}
      \begin{center}
\fbox{\includegraphics[width=0.8\textwidth-2\fboxsep-2\fboxrule]{tabelle2_1_2}}
      \end{center}
Quelle: Stephan Jobstmann
\label{fig:2.2}
\end{figure}
...
\caption[Messung 3 und 4; Sonox 502 unter Einsatz besserer Spannvorrichtung]{Messung 3 und 4; Sonox 502 Kapazitives Verhalten über steigende mechanische Belastung unter Einsatz besserer Spannvorrichtung}
      \begin{center}
  \fbox{\includegraphics[width=0.8\textwidth-2\fboxsep-2\fboxrule]{tabelle2_1_3}}
      \end{center}
Quelle: Stephan Jobstmann
\label{fig:2.3}
\end{figure}
...
\caption{Messung 5; 1kHz Messfrequenz}
      \begin{center}
    \fbox{\includegraphics[width=0.8\textwidth-2\fboxsep-2\fboxrule]{tabelle2_1_4}}
      \end{center}
Quelle: Stephan Jobstmann
\label{fig:2.4}
\end{figure}
...
\caption{Messung 6; Einführende Messung Piezostack}
      \begin{center}
      \fbox{\includegraphics[width=0.8\textwidth-2\fboxsep-2\fboxrule]{tabelle2_2_1}}
      \end{center}
Quelle: Stephan Jobstmann
\label{fig:2.6}
\end{figure}
...
\caption{Messung 7; mit Entladung, ohne Setz-Zeit; Piezostack; Kapazität}
      \begin{center}
     \fbox{\includegraphics[width=0.8\textwidth-2\fboxsep-2\fboxrule]{tabelle2_2_2}}
      \end{center}
Quelle: Stephan Jobstmann
\label{fig:2.7}
\end{figure}
...
\caption[Messung 8; ohne Setz-Zeit; Parallelwiderstand]{Messung 8; Piezostack; mit Entladung, ohne Setz-Zeit; Parallelwiderstand}
      \begin{center}
       \fbox{\includegraphics[width=0.8\textwidth-2\fboxsep-2\fboxrule]{tabelle2_2_3}}
      \end{center}
Quelle: Stephan Jobstmann
\label{fig:2.8}
\end{figure}
...
\caption[Messung 9; 2 Minuten Setz-Zeit; Piezostack; Kapazität]{Messung 9; mit Entladung, 2 Minuten Setz-Zeit; Piezostack; Kapazität}
      \begin{center}
        \fbox{\includegraphics[width=0.8\textwidth-2\fboxsep-2\fboxrule]{tabelle2_2_4}}
      \end{center}
Quelle: Stephan Jobstmann
\label{fig:2.9}
\end{figure}
...
\caption[Messung 10; 2 Minuten Setz-Zeit; Piezostack; Parallelwiderstand]{Messung 10; mit Entladung, 2 Minuten Setz-Zeit; Piezostack; Parallelwiderstand}
      \begin{center}
       \fbox{\includegraphics[width=0.8\textwidth-2\fboxsep-2\fboxrule]{tabelle2_2_5}}
      \end{center}
Quelle: Stephan Jobstmann
\label{fig:2.10}
\end{figure}
...
\fbox{\includegraphics[width=1\textwidth-2\fboxsep-2\fboxrule]{Bilder/self_receiver.JPG}}
Quelle: Stephan Jobstmann
\label{self_rec}
\end{figure}
...
\fbox{\includegraphics[width=1\textwidth-2\fboxsep-2\fboxrule]{Bilder/TXLine.png}}
Quelle: Stephan Jobstmann
\label{TXLine}
\end{figure}
...
\fbox{\includegraphics[width=1\textwidth-2\fboxsep-2\fboxrule]{Bilder/CC2541.JPG}}
Quelle: Stephan Jobstmann
\label{pic.CC2541}
\end{figure}
...
\fbox{\includegraphics[width=1\textwidth-2\fboxsep-2\fboxrule]{Bilder/breakout.JPG}}
Quelle: Stephan Jobstmann
\label{pic.breakout}
\end{figure}
\end{itemize}
...
\fbox{\includegraphics[width=1\textwidth-2\fboxsep-2\fboxrule]{Bilder/CC430.JPG}}
Quelle: Stephan Jobstmann
\label{pic.CC430}
\end{figure}
\subsection{Sensorik}
...
\fbox{\includegraphics[width=1\textwidth-2\fboxsep-2\fboxrule]{Bilder/ad1232.JPG}}
Quelle: Stephan Jobstmann
\label{pic.ad1232}
\end{figure}
\begin{itemize}
...
\item
Zusammenführen einzelner Komponenten, beispielsweise Energieübertragung und Lade-Schaltung
\item
