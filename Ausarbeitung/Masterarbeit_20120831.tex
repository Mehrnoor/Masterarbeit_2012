...
\begin {figure}[htbp]
      \begin{center}
\fbox{\includegraphics[width=0.8\textwidth-2\fboxsep-2\fboxrule]{tabelle_stat2}}
      \end{center}
...
\caption[AD1232 A/D-Wandler Schaltbild]{Zentrales Element der Modul-Schaltung ist der AD1232 A/D-Wandler. Das Schaltbild wurde mit der Software Multisim v12 angefertigt.\\\\\emph{Quelle: eigene Darstellung}}
\label{sch.ad1232}
\end{figure}
\begin{figure}
\centering
...
\caption[Schaltbild des Lademoduls, BQ24100]{Schaltbild des Lademoduls mit BQ24100 Baustein\\\\\emph{Quelle: eigene Darstellung}}
\label{pic.BQ24100}
\end{figure}
...
\caption[Schaltbild des Moduls, CC2541]{Schaltbild des Moduls für den CC2541 Baustein\\\\\emph{Quelle: eigene Darstellung}}
\label{pic.cc2541}
\end{figure}
\begin{itemize}
\item
...
\caption[Schaltbild des Modulentwurfs, CC430F6137]{Schaltbild des Modulentwurfs für den CC430F6137 Baustein\\\\\emph{Quelle: eigene Darstellung}}
\label{pic.cc430}
\end{figure}
\begin{itemize}
\item
...
\caption{Eine Modulplatine mit zentralen CC430F6137-Baustein auf FR4-Substrat; Hergestellt an der Hochschule Landshut}
\label{pic.CC430}
\end{figure}
...
\caption{Transmitter-Modul bq500110EVM-688 des Evaluation-Packs von Texas Instruments}
\label{BQ_transm}
\end{figure}
\begin{figure}
\centering
\fbox{\includegraphics[width=0.8\textwidth-2\fboxsep-2\fboxrule]{Bilder/BQ_Tesla_receiver.JPG}}
\caption{Receiver-Modul bq51013EVM-725 des Evaluation-Packs von Texas Instruments}
\label{BQ_rec}
\end{figure}
...
\caption{Im Bild ist links das bläuliche selbst entworfene LTCC-Receiver Modul zu erkennen. Über diesem ist ein Lastwiderstand zu sehen, rechts daneben ist eine kleine Platine mit SMD-Kondensatoren zum Abstimmen des Schwingkreises. Ganz rechts außen ist die zugekaufte Koppelspule zu sehen. Hergestellt wurde der Verbund im Hybridlabor der Hochschule Landshut}
\label{self_rec}
\end{figure}
