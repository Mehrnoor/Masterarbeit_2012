...
/*Folgender Codeausschnitt bewirkt nur eine laufende 
  Animation auf dem LCD-EA T123-I2C*/
#ifdef EVAL_BOARD
	...
	/*Erkennen des Vorzeichenbits und 
	Auswertung als Symbol*/
	ken5[5] = (e > 0x7FFF) ? 0x2D : 0x2B;

	e = e << 1;			   	//Entfernung des 
	e = e >> 1;				//Vorzeichenbits
...
/*Folgender Codeausschnitt bewirkt nur eine laufende 
  Animation auf dem LCD-EA T123-I2C*/	
	...
	/*Kuerzen des 32Bit ulong Wertes 
	  auf den 24Bit-Inhalt.
...
void SPI_read(void)
{
	...
	/*eventuell muss zum Pollen des DATAREADY-Zustands 
	  der SPI-MODE der GPIO ausgeschalten werden!*/
	//SPI0CN &= 0xFE;
